...
//         typeid
    ...
    public void testDelayMessage() {
        // 测试发送延时消息
        String msg = "{\"id\":123,\"userId\":456,\"voucherId\":789,\"status\":1}";
        // 发送5秒延时消息
        rabbitTemplate.convertAndSend("delay.order.exchange", "delay.order", msg, message -> {
            message.getMessageProperties().setDelay(5000);
            return message;
        });
        System.out.println("发送延时消息成功");
    }
